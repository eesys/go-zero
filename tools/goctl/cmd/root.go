...
import (
	...
	"github.com/eesys/go-zero/tools/goctl/api"
	"github.com/eesys/go-zero/tools/goctl/bug"
	"github.com/eesys/go-zero/tools/goctl/config"
	"github.com/eesys/go-zero/tools/goctl/docker"
	"github.com/eesys/go-zero/tools/goctl/env"
	"github.com/eesys/go-zero/tools/goctl/gateway"
	"github.com/eesys/go-zero/tools/goctl/internal/cobrax"
	"github.com/eesys/go-zero/tools/goctl/internal/version"
	"github.com/eesys/go-zero/tools/goctl/kube"
	"github.com/eesys/go-zero/tools/goctl/migrate"
	"github.com/eesys/go-zero/tools/goctl/model"
	"github.com/eesys/go-zero/tools/goctl/quickstart"
	"github.com/eesys/go-zero/tools/goctl/rpc"
	"github.com/eesys/go-zero/tools/goctl/tpl"
	"github.com/eesys/go-zero/tools/goctl/upgrade"
