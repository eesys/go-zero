...
import (
	...
	"github.com/eesys/go-zero/tools/goctl/api/apigen"
	"github.com/eesys/go-zero/tools/goctl/api/dartgen"
	"github.com/eesys/go-zero/tools/goctl/api/docgen"
	"github.com/eesys/go-zero/tools/goctl/api/format"
	"github.com/eesys/go-zero/tools/goctl/api/gogen"
	"github.com/eesys/go-zero/tools/goctl/api/javagen"
	"github.com/eesys/go-zero/tools/goctl/api/ktgen"
	"github.com/eesys/go-zero/tools/goctl/api/new"
	"github.com/eesys/go-zero/tools/goctl/api/swagger"
	"github.com/eesys/go-zero/tools/goctl/api/tsgen"
	"github.com/eesys/go-zero/tools/goctl/api/validate"
	"github.com/eesys/go-zero/tools/goctl/config"
	"github.com/eesys/go-zero/tools/goctl/internal/cobrax"
	"github.com/eesys/go-zero/tools/goctl/plugin"
)
